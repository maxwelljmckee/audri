...
export default function HomeScreen() {
  ...
  // Home no longer flips status to 'connecting'. call.tsx / chat.tsx own
  // the session lifecycle: on mount with status === 'idle' they kick
  // start(); on mount with any other status they rejoin without re-starting.
